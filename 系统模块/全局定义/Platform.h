...
//地址定义
const TCHAR szCookieUrl[]=TEXT("http://wx.metrox.com.cn");					//记录地址
const TCHAR szLogonServer[]=TEXT("wx.metrox.com.cn");						//登录地址
const TCHAR szPlatformLink[]=TEXT("http://wx.metrox.com.cn");				//平台网站
...
//授权信息
const TCHAR szCompilation[]=TEXT("9237B617-5CDE-4A53-A24A-1C42C59157B5");
